...
<head>
    ...
    <title>Profile | Rental Hub Admin</title>
</head>
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('../dist/images/<?php echo $_SESSION['image'] ?>')"></div>
			
			<h1 class="text-3xl font-bold pt-8 lg:pt-0"> <?php echo $_SESSION['name'] ?> </h1>
			<div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
			<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg class="h-4 fill-current text-green-700 pr-4" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Gmail icon</title><path d="M24 4.5v15c0 .85-.65 1.5-1.5 1.5H21V7.387l-9 6.463-9-6.463V21H1.5C.649 21 0 20.35 0 19.5v-15c0-.425.162-.8.431-1.068C.7 3.16 1.076 3 1.5 3H2l10 7.25L22 3h.5c.425 0 .8.162 1.069.432.27.268.431.643.431 1.068z"/></svg> <?php echo $_SESSION['email'] ?> </p>
			...
			<p class="pt-8 text-sm">Totally optional short description about user, their work and so on.</p>

			<div class="pt-12 pb-8">
				<a href="editProfile.php" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
				  Edit Profile
			</a> 
			</div>
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="../dist/images/<?php echo $_SESSION['image'] ?>" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
